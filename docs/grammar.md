...
&nbsp;&nbsp;&nbsp;&nbsp;\| [expression](#expression) `->` [constraint_set](#constraint_set)  
...
&nbsp;&nbsp;&nbsp;&nbsp;\| [net_type_identifier](#net_type_identifier) \[ [delay_control](#delay_control) ]  
...
&nbsp;&nbsp;&nbsp;&nbsp;[type_identifier](#type_identifier) \[ `=` [data_type](#data_type) ]  
...
<a name="list_of_port_connections"></a>list\_of\_port\_connections ::=  
...
<a name="list_of_checker_port_connections"></a>list\_of\_checker\_port\_connections ::=  
...
&nbsp;&nbsp;&nbsp;&nbsp;[generate](#generate) \{ [generate_item](#generate_item) } [endgenerate](#endgenerate)  
<a name="loop_generate_construct"></a>loop\_generate\_construct ::=  
&nbsp;&nbsp;&nbsp;&nbsp;[for](#for) `(` [genvar_initialization](#genvar_initialization) `;` [genvar_expression](#genvar_expression) `;` [genvar_iteration](#genvar_iteration) `)`  
...
&nbsp;&nbsp;&nbsp;&nbsp;[if](#if) `(` [constant_expression](#constant_expression) `)` [generate_block](#generate_block) \[ [else](#else) [generate_block](#generate_block) ]  
...
<a name="generate_item"></a>generate\_item ::=  
&nbsp;&nbsp;&nbsp;&nbsp;[module_or_generate_item](#module_or_generate_item)  
&nbsp;&nbsp;&nbsp;&nbsp;\| [interface_or_generate_item](#interface_or_generate_item)  
...
&nbsp;&nbsp;&nbsp;&nbsp;[procedural_timing_control](#procedural_timing_control) [statement_or_null](#statement_or_null)  
...
<a name="event_expression"></a>event\_expression ::=  
...
&nbsp;&nbsp;&nbsp;&nbsp;[expression_or_cond_pattern](#expression_or_cond_pattern) \{ `&&&` [expression_or_cond_pattern](#expression_or_cond_pattern) }  
<a name="expression_or_cond_pattern"></a>expression\_or\_cond\_pattern ::=  
&nbsp;&nbsp;&nbsp;&nbsp;[expression](#expression) \| [cond_pattern](#cond_pattern)  
...
&nbsp;&nbsp;&nbsp;&nbsp;[open_range_list](#open_range_list) `:` [statement_or_null](#statement_or_null)  
&nbsp;&nbsp;&nbsp;&nbsp;\| [default](#default) \[ `:` ] [statement_or_null](#statement_or_null)  
...
&nbsp;&nbsp;&nbsp;&nbsp;[randcase](#randcase) [randcase_item](#randcase_item) \{ [randcase_item](#randcase_item) } [endcase](#endcase)  
...
&nbsp;&nbsp;&nbsp;&nbsp;\| [type_reference](#type_reference)  
<a name="constant_assignment_pattern_expression"></a>constant\_assignment\_pattern\_expression ::= [assignment_pattern_expression](#assignment_pattern_expression)  
...
&nbsp;&nbsp;&nbsp;&nbsp;\| [for](#for) `(` \[ [for_initialization](#for_initialization) ] `;` \[ [expression](#expression) ] `;` \[ [for_step](#for_step) ] `)`  
&nbsp;&nbsp;&nbsp;&nbsp;[statement_or_null](#statement_or_null)  
...
&nbsp;&nbsp;&nbsp;&nbsp;[clockvar_expression](#clockvar_expression) `<=` \[ [cycle_delay](#cycle_delay) ] [expression](#expression)  
...
### A.6.12 Randsequence
<a name="randsequence_statement"></a>randsequence\_statement ::= [randsequence](#randsequence) `(` \[ [production_identifier](#production_identifier) ] `)`  
...
&nbsp;&nbsp;&nbsp;&nbsp;[case_item_expression](#case_item_expression) \{ `,` [case_item_expression](#case_item_expression) } `:` [production_item](#production_item) `;`  
&nbsp;&nbsp;&nbsp;&nbsp;\| [default](#default) \[ `:` ] [production_item](#production_item) `;`  
## A.7 Specify section
...
&nbsp;&nbsp;&nbsp;&nbsp;[specify_output_terminal_descriptor](#specify_output_terminal_descriptor) \{ `,` [specify_output_terminal_descriptor](#specify_output_terminal_descriptor) }  
### A.7.3 Specify block terminals
<a name="specify_input_terminal_descriptor"></a>specify\_input\_terminal\_descriptor ::=  
&nbsp;&nbsp;&nbsp;&nbsp;[input_identifier](#input_identifier) \[ \[ [constant_range_expression](#constant_range_expression) ] ]  
<a name="specify_output_terminal_descriptor"></a>specify\_output\_terminal\_descriptor ::=  
&nbsp;&nbsp;&nbsp;&nbsp;[output_identifier](#output_identifier) \[ \[ [constant_range_expression](#constant_range_expression) ] ]  
...
<a name="edge_descriptor"></a>edge\_descriptor ::= [01](#01) \| [10](#10) \| [z_or_x](#z_or_x) [zero_or_one](#zero_or_one) \| [zero_or_one](#zero_or_one) [z_or_x](#z_or_x)  
...
<a name="multiple_concatenation"></a>multiple\_concatenation ::= \{ [expression](#expression) [concatenation](#concatenation) }  
...
&nbsp;&nbsp;&nbsp;&nbsp;\| [expression](#expression) `+:` [expression](#expression)  
&nbsp;&nbsp;&nbsp;&nbsp;\| [expression](#expression) `-:` [expression](#expression)  
<a name="empty_queue"></a>empty\_queue ::= \{ }  
### A.8.2 Subroutine calls
<a name="constant_function_call"></a>constant\_function\_call ::= [function_subroutine_call](#function_subroutine_call)  
<a name="tf_call"></a>tf\_call ::= [ps_or_hierarchical_tf_identifier](#ps_or_hierarchical_tf_identifier) \{ [attribute_instance](#attribute_instance) } \[ `(` [list_of_arguments](#list_of_arguments) `)` ]  
...
&nbsp;&nbsp;&nbsp;&nbsp;\[ [with](#with) \[ `(` \[ [identifier_list](#identifier_list) ] `)` ] [constraint_block](#constraint_block) ]  
...
&nbsp;&nbsp;&nbsp;&nbsp;[method_identifier](#method_identifier) \| [unique](#unique) \| [and](#and) \| [or](#or) \| [xor](#xor)  
### A.8.3 Expressions
...
&nbsp;&nbsp;&nbsp;&nbsp;[constant_mintypmax_expression](#constant_mintypmax_expression) \| [data_type](#data_type) \| `$`  
...
&nbsp;&nbsp;&nbsp;&nbsp;[tagged](#tagged) [member_identifier](#member_identifier) \[ [expression](#expression) ]  
...
&nbsp;&nbsp;&nbsp;&nbsp;\| `$`  
&nbsp;&nbsp;&nbsp;&nbsp;\| [null](#null)  
&nbsp;&nbsp;&nbsp;&nbsp;[class_qualifier](#class_qualifier) `:=` \[ [local](#local)`::` ] \[ [implicit_class_handle](#implicit_class_handle) `.` \| [class_scope](#class_scope) ]  
...
<a name="time_literal"></a>time\_literal ::=  
...
<a name="implicit_class_handle"></a>implicit\_class\_handle ::= [this](#this) \| [super](#super) \| [this](#this) `.` [super](#super)  
...
&nbsp;&nbsp;&nbsp;&nbsp;[casting_type](#casting_type) `'` `(` [constant_expression](#constant_expression) `)`  
<a name="constant_let_expression"></a>constant\_let\_expression ::= [let_expression](#let_expression)  
<a name="cast"></a>cast ::=  
&nbsp;&nbsp;&nbsp;&nbsp;[casting_type](#casting_type) `'` `(` [expression](#expression) `)`  
...
&nbsp;&nbsp;&nbsp;&nbsp;\[ [implicit_class_handle](#implicit_class_handle) `.` \| [package_scope](#package_scope) ] [hierarchical_variable_identifier](#hierarchical_variable_identifier) [select](#select)  
&nbsp;&nbsp;&nbsp;&nbsp;\| \{ [variable_lvalue](#variable_lvalue) \{ `,` [variable_lvalue](#variable_lvalue) } }  
...
<a name="real_number33"></a>real\_number33 ::=  
...
<a name="unbased_unsized_literal"></a>unbased\_unsized\_literal ::= `'`[0](#0) \| `'`[1](#1) \| `'`[z_or_x](#z_or_x)  
### A.8.8 Strings
...
<a name="c_identifier"></a>c\_identifier ::= \[ [a](#a)`-`[zA](#zA)`-`[Z_](#Z_) ] \{ \[ [a](#a)`-`[zA](#zA)`-`[Z0](#Z0)`-`[9_](#9_) ] }  
...
<a name="ps_type_identifier"></a>ps\_type\_identifier ::= \[ [local](#local)`::` \| [package_scope](#package_scope) ] [type_identifier](#type_identifier)  
...
<a name="simple_identifier"></a>simple\_identifier ::= \[ [a](#a)`-`[zA](#zA)`-`[Z_](#Z_) ] \{ \[ [a](#a)`-`[zA](#zA)`-`[Z0](#Z0)`-`[9_](#9_)`$` ] }  
<a name="specparam_identifier"></a>specparam\_identifier ::= [identifier](#identifier)  
<a name="system_tf_identifier"></a>system\_tf\_identifier ::= `$[` [a](#a)`-`[zA](#zA)`-`[Z0](#Z0)`-`[9_](#9_)`$` `]{` \[ [a](#a)`-`[zA](#zA)`-`[Z0](#Z0)`-`[9_](#9_)`$` ] }  
