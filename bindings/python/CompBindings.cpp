...
void registerCompilation(nb::module_& m, nb::module_& ast, nb::module_& driver) {
    ...
    comp.def(nb::init<>())
        ...
        .def("__repr__", [](const Compilation&) { return "Compilation()"; })
        ...
        .def_prop_ro("bitType", &Compilation::getBitType, byrefint)
        .def_prop_ro("logicType", &Compilation::getLogicType, byrefint)
        .def_prop_ro("intType", &Compilation::getIntType, byrefint)
        .def_prop_ro("byteType", &Compilation::getByteType, byrefint)
        .def_prop_ro("integerType", &Compilation::getIntegerType, byrefint)
        .def_prop_ro("realType", &Compilation::getRealType, byrefint)
        .def_prop_ro("shortRealType", &Compilation::getShortRealType, byrefint)
        .def_prop_ro("stringType", &Compilation::getStringType, byrefint)
        .def_prop_ro("voidType", &Compilation::getVoidType, byrefint)
        .def_prop_ro("errorType", &Compilation::getErrorType, byrefint)
        .def_prop_ro("unsignedIntType", &Compilation::getUnsignedIntType, byrefint)
        .def_prop_ro("nullType", &Compilation::getNullType, byrefint)
        .def_prop_ro("unboundedType", &Compilation::getUnboundedType, byrefint)
        .def_prop_ro("typeRefType", &Compilation::getTypeRefType, byrefint)
        .def_prop_ro("wireNetType", &Compilation::getWireNetType, byrefint)
    ...
    nb::class_<Compilation::DPIExport>(comp, "DPIExport")
        .def_ro("subroutine", &Compilation::DPIExport::subroutine, byrefint)
        .def_ro("cIdentifier", &Compilation::DPIExport::cIdentifier)
        .def_ro("syntax", &Compilation::DPIExport::syntax, byrefint);

    nb::class_<ScriptSession>(ast, "ScriptSession")
        .def(nb::init<>())
        .def_ro("compilation", &ScriptSession::compilation, byrefint)
    ...
    driverClass.def(nb::init<>())
        .def_ro("sourceManager", &Driver::sourceManager, byrefint)
        .def_ro("diagEngine", &Driver::diagEngine, byrefint)
        .def_ro("textDiagClient", &Driver::textDiagClient, byrefint)
        .def_ro("sourceLoader", &Driver::sourceLoader, byrefint)
        .def_ro("syntaxTrees", &Driver::syntaxTrees, byrefint)
        .def_rw("languageVersion", &Driver::languageVersion)
        .def_prop_ro("analysisOptions", &Driver::getAnalysisOptions, byrefint)
        .def_prop_ro("commandFileMetadata", &Driver::getCommandFileMetadata, byrefint)
