...
void registerTypes(py::module_& m) {
    ...
    py::class_<Type, Symbol>(m, "Type")
        ...
        .def("isMatching", &Type::isMatching, py::arg("rhs"))
        .def("isEquivalent", &Type::isEquivalent, py::arg("rhs"))
        .def("isAssignmentCompatible", &Type::isAssignmentCompatible, py::arg("rhs"))
        .def("isCastCompatible", &Type::isCastCompatible, py::arg("rhs"))
        .def("isBitstreamCastable", &Type::isBitstreamCastable, py::arg("rhs"))
        .def("isDerivedFrom", &Type::isDerivedFrom, py::arg("rhs"))
        .def("implements", &Type::implements, py::arg("rhs"))
        .def("isValidForRand", &Type::isValidForRand, py::arg("rhs"))
        .def("coerceValue", &Type::coerceValue, py::arg("rhs"))
    ...
    py::class_<TypePrinter>(m, "TypePrinter")
        ...
        .def("append", &TypePrinter::append, py::arg("type"))
