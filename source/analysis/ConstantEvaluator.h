...
/// constant value. If the tree is not constant, appropriate diagnostics will
...
public:
    ...
    /// constant expression diagnostics will be issued to help indicate why not.
    ...
    /// `evaluate` to materialize temporaries that don't have declarations within
    /// the evaluated tree.
