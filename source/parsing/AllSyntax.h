...
void dispatchVisitor(T& v, const SyntaxNode* node) {
    ...
    switch (node->kind) {
        ...
        case SyntaxKind::ModportClockingPort: SyntaxNode::dispatch(v, *(const ModportClockingPortSyntax*)node); break;
        case SyntaxKind::ModportDeclaration: SyntaxNode::dispatch(v, *(const ModportDeclarationSyntax*)node); break;
        case SyntaxKind::ModportExplicitPort: SyntaxNode::dispatch(v, *(const ModportExplicitPortSyntax*)node); break;
        case SyntaxKind::ModportItem: SyntaxNode::dispatch(v, *(const ModportItemSyntax*)node); break;
        case SyntaxKind::ModportNamedPort: SyntaxNode::dispatch(v, *(const ModportNamedPortSyntax*)node); break;
        case SyntaxKind::ModportSimplePortList: SyntaxNode::dispatch(v, *(const ModportSimplePortListSyntax*)node); break;
        case SyntaxKind::ModportSubroutinePort: SyntaxNode::dispatch(v, *(const ModportSubroutinePortSyntax*)node); break;
        case SyntaxKind::ModportSubroutinePortList: SyntaxNode::dispatch(v, *(const ModportSubroutinePortListSyntax*)node); break;
        ...
        case SyntaxKind::SequenceDeclaration: SyntaxNode::dispatch(v, *(const SequenceDeclarationSyntax*)node); break;
