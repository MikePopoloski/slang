...
namespace Catch {
    ...
    template<typename LhsT, typename RhsT>
    auto compareEqual( LhsT const& lhs, RhsT const& rhs ) -> bool { return bool(lhs == rhs); };
    template<typename T>
    ...
    template<typename LhsT, typename RhsT>
    auto compareNotEqual( LhsT const& lhs, RhsT&& rhs ) -> bool { return bool(lhs != rhs); };
    template<typename T>
    ...
    public:
        ...
        auto operator == ( bool rhs ) -> BinaryExpr<LhsT, bool> const {
            return BinaryExpr<LhsT, bool>( bool(m_lhs == rhs), m_lhs, "==", rhs );
        }
        ...
        template<typename RhsT>
        auto operator > ( RhsT const& rhs ) -> BinaryExpr<LhsT, RhsT const&> const {
            return BinaryExpr<LhsT, RhsT const&>( bool(m_lhs > rhs), m_lhs, ">", rhs );
        }
        template<typename RhsT>
        auto operator < ( RhsT const& rhs ) -> BinaryExpr<LhsT, RhsT const&> const {
            return BinaryExpr<LhsT, RhsT const&>( bool(m_lhs < rhs), m_lhs, "<", rhs );
