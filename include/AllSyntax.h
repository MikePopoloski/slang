...
void dispatchVisitor(T& v, const SyntaxNode* node) {
    ...
    switch (node->kind) {
        ...
        case SyntaxKind::ParameterPortList: SyntaxNode::has_visit<T, void(const ParameterPortListSyntax&)>::value ? v.visit(*(const ParameterPortListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DivideExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NonblockingEventTriggerStatement: SyntaxNode::has_visit<T, void(const EventTriggerStatementSyntax&)>::value ? v.visit(*(const EventTriggerStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TypeType: SyntaxNode::has_visit<T, void(const KeywordTypeSyntax&)>::value ? v.visit(*(const KeywordTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DistWeight: SyntaxNode::has_visit<T, void(const DistWeightSyntax&)>::value ? v.visit(*(const DistWeightSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnarySequenceEventExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BinaryAndExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::VariablePattern: SyntaxNode::has_visit<T, void(const VariablePatternSyntax&)>::value ? v.visit(*(const VariablePatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SUntilWithPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WithinSequenceExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExternModule: SyntaxNode::has_visit<T, void(const ExternModuleSyntax&)>::value ? v.visit(*(const ExternModuleSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryNotPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NonblockingAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CycleDelay: SyntaxNode::has_visit<T, void(const DelaySyntax&)>::value ? v.visit(*(const DelaySyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DataTypeDimensionSpecifier: SyntaxNode::has_visit<T, void(const DataTypeDimensionSpecifierSyntax&)>::value ? v.visit(*(const DataTypeDimensionSpecifierSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConstraintPrototype: SyntaxNode::has_visit<T, void(const ConstraintPrototypeSyntax&)>::value ? v.visit(*(const ConstraintPrototypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MacroArgumentDefault: SyntaxNode::has_visit<T, void(const MacroArgumentDefaultSyntax&)>::value ? v.visit(*(const MacroArgumentDefaultSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImplicitAnsiPort: SyntaxNode::has_visit<T, void(const ImplicitAnsiPortSyntax&)>::value ? v.visit(*(const ImplicitAnsiPortSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DefaultPatternKeyExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NextTimePropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OrSequenceExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicalShiftRightExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImplicitEventControl: SyntaxNode::has_visit<T, void(const ImplicitEventControlSyntax&)>::value ? v.visit(*(const ImplicitEventControlSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ForVariableDeclaration: SyntaxNode::has_visit<T, void(const ForVariableDeclarationSyntax&)>::value ? v.visit(*(const ForVariableDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DisableForkStatement: SyntaxNode::has_visit<T, void(const DisableForkStatementSyntax&)>::value ? v.visit(*(const DisableForkStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ElseConstraintClause: SyntaxNode::has_visit<T, void(const ElseConstraintClauseSyntax&)>::value ? v.visit(*(const ElseConstraintClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConditionalConstraint: SyntaxNode::has_visit<T, void(const ConditionalConstraintSyntax&)>::value ? v.visit(*(const ConditionalConstraintSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ReturnStatement: SyntaxNode::has_visit<T, void(const ReturnStatementSyntax&)>::value ? v.visit(*(const ReturnStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ContinuousAssign: SyntaxNode::has_visit<T, void(const ContinuousAssignSyntax&)>::value ? v.visit(*(const ContinuousAssignSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryBitwiseNorExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ParenImplicitEventControl: SyntaxNode::has_visit<T, void(const ParenImplicitEventControlSyntax&)>::value ? v.visit(*(const ParenImplicitEventControlSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NamedType: SyntaxNode::has_visit<T, void(const NamedTypeSyntax&)>::value ? v.visit(*(const NamedTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DelayControl: SyntaxNode::has_visit<T, void(const DelaySyntax&)>::value ? v.visit(*(const DelaySyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TaskDeclaration: SyntaxNode::has_visit<T, void(const FunctionDeclarationSyntax&)>::value ? v.visit(*(const FunctionDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AttributeSpec: SyntaxNode::has_visit<T, void(const AttributeSpecSyntax&)>::value ? v.visit(*(const AttributeSpecSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ShortcutCycleDelayRange: SyntaxNode::has_visit<T, void(const ShortcutCycleDelayRangeSyntax&)>::value ? v.visit(*(const ShortcutCycleDelayRangeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExpressionPattern: SyntaxNode::has_visit<T, void(const ExpressionPatternSyntax&)>::value ? v.visit(*(const ExpressionPatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EmptyMember: SyntaxNode::has_visit<T, void(const EmptyMemberSyntax&)>::value ? v.visit(*(const EmptyMemberSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NullLiteralExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ModuleHeader: SyntaxNode::has_visit<T, void(const ModuleHeaderSyntax&)>::value ? v.visit(*(const ModuleHeaderSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::HierarchyInstantiation: SyntaxNode::has_visit<T, void(const HierarchyInstantiationSyntax&)>::value ? v.visit(*(const HierarchyInstantiationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ParallelBlockStatement: SyntaxNode::has_visit<T, void(const BlockStatementSyntax&)>::value ? v.visit(*(const BlockStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AddAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DefaultNetTypeDirective: SyntaxNode::has_visit<T, void(const DefaultNetTypeDirectiveSyntax&)>::value ? v.visit(*(const DefaultNetTypeDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CaseInequalityExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StructuredAssignmentPattern: SyntaxNode::has_visit<T, void(const StructuredAssignmentPatternSyntax&)>::value ? v.visit(*(const StructuredAssignmentPatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::FunctionPort: SyntaxNode::has_visit<T, void(const FunctionPortSyntax&)>::value ? v.visit(*(const FunctionPortSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ClassScope: SyntaxNode::has_visit<T, void(const ClassScopeSyntax&)>::value ? v.visit(*(const ClassScopeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OrderedStructurePatternMember: SyntaxNode::has_visit<T, void(const OrderedStructurePatternMemberSyntax&)>::value ? v.visit(*(const OrderedStructurePatternMemberSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ClassMethodPrototype: SyntaxNode::has_visit<T, void(const ClassMethodPrototypeSyntax&)>::value ? v.visit(*(const ClassMethodPrototypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IdentifierSelectName: SyntaxNode::has_visit<T, void(const IdentifierSelectNameSyntax&)>::value ? v.visit(*(const IdentifierSelectNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AssignmentPatternExpression: SyntaxNode::has_visit<T, void(const AssignmentPatternExpressionSyntax&)>::value ? v.visit(*(const AssignmentPatternExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImmediateAssertStatement: SyntaxNode::has_visit<T, void(const ImmediateAssertionStatementSyntax&)>::value ? v.visit(*(const ImmediateAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DistItem: SyntaxNode::has_visit<T, void(const DistItemSyntax&)>::value ? v.visit(*(const DistItemSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StreamingConcatenationExpression: SyntaxNode::has_visit<T, void(const StreamingConcatenationExpressionSyntax&)>::value ? v.visit(*(const StreamingConcatenationExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EndIfDirective: SyntaxNode::has_visit<T, void(const UnconditionalBranchDirectiveSyntax&)>::value ? v.visit(*(const UnconditionalBranchDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::InvocationExpression: SyntaxNode::has_visit<T, void(const InvocationExpressionSyntax&)>::value ? v.visit(*(const InvocationExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BinaryOrExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MinTypMaxExpression: SyntaxNode::has_visit<T, void(const MinTypMaxExpressionSyntax&)>::value ? v.visit(*(const MinTypMaxExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ModportItem: SyntaxNode::has_visit<T, void(const ModportItemSyntax&)>::value ? v.visit(*(const ModportItemSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MultiplyAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryBitwiseNotExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AttributeInstance: SyntaxNode::has_visit<T, void(const AttributeInstanceSyntax&)>::value ? v.visit(*(const AttributeInstanceSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::InterfaceHeader: SyntaxNode::has_visit<T, void(const ModuleHeaderSyntax&)>::value ? v.visit(*(const ModuleHeaderSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::QueueDimensionSpecifier: SyntaxNode::has_visit<T, void(const QueueDimensionSpecifierSyntax&)>::value ? v.visit(*(const QueueDimensionSpecifierSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DivideAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DividerClause: SyntaxNode::has_visit<T, void(const DividerClauseSyntax&)>::value ? v.visit(*(const DividerClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArrayOrMethod: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MatchesClause: SyntaxNode::has_visit<T, void(const MatchesClauseSyntax&)>::value ? v.visit(*(const MatchesClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AlwaysPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LetPort: SyntaxNode::has_visit<T, void(const LetPortSyntax&)>::value ? v.visit(*(const LetPortSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NewArrayExpression: SyntaxNode::has_visit<T, void(const NewArrayExpressionSyntax&)>::value ? v.visit(*(const NewArrayExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::XorAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TimescaleDirective: SyntaxNode::has_visit<T, void(const TimescaleDirectiveSyntax&)>::value ? v.visit(*(const TimescaleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AndSequenceExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AndAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DisableConstraint: SyntaxNode::has_visit<T, void(const DisableConstraintSyntax&)>::value ? v.visit(*(const DisableConstraintSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WildcardEqualityExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RandomizeMethodWithClause: SyntaxNode::has_visit<T, void(const RandomizeMethodWithClauseSyntax&)>::value ? v.visit(*(const RandomizeMethodWithClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryMinusExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DefaultCaseItem: SyntaxNode::has_visit<T, void(const DefaultCaseItemSyntax&)>::value ? v.visit(*(const DefaultCaseItemSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EventControl: SyntaxNode::has_visit<T, void(const EventControlSyntax&)>::value ? v.visit(*(const EventControlSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryLogicalNotExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PragmaDirective: SyntaxNode::has_visit<T, void(const SimpleDirectiveSyntax&)>::value ? v.visit(*(const SimpleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConditionalPattern: SyntaxNode::has_visit<T, void(const ConditionalPatternSyntax&)>::value ? v.visit(*(const ConditionalPatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TypeReference: SyntaxNode::has_visit<T, void(const TypeReferenceSyntax&)>::value ? v.visit(*(const TypeReferenceSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImplicitType: SyntaxNode::has_visit<T, void(const ImplicitTypeSyntax&)>::value ? v.visit(*(const ImplicitTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LineDirective: SyntaxNode::has_visit<T, void(const LineDirectiveSyntax&)>::value ? v.visit(*(const LineDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TaggedUnionExpression: SyntaxNode::has_visit<T, void(const TaggedUnionExpressionSyntax&)>::value ? v.visit(*(const TaggedUnionExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TimingControlExpression: SyntaxNode::has_visit<T, void(const TimingControlExpressionSyntax&)>::value ? v.visit(*(const TimingControlExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BlockingEventTriggerStatement: SyntaxNode::has_visit<T, void(const EventTriggerStatementSyntax&)>::value ? v.visit(*(const EventTriggerStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ParenthesizedEventExpression: SyntaxNode::has_visit<T, void(const ParenthesizedEventExpressionSyntax&)>::value ? v.visit(*(const ParenthesizedEventExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ResetAllDirective: SyntaxNode::has_visit<T, void(const SimpleDirectiveSyntax&)>::value ? v.visit(*(const SimpleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RealType: SyntaxNode::has_visit<T, void(const KeywordTypeSyntax&)>::value ? v.visit(*(const KeywordTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EqualsValueClause: SyntaxNode::has_visit<T, void(const EqualsValueClauseSyntax&)>::value ? v.visit(*(const EqualsValueClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TypedefKeywordDeclaration: SyntaxNode::has_visit<T, void(const TypedefKeywordDeclarationSyntax&)>::value ? v.visit(*(const TypedefKeywordDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnitScope: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PropertySpec: SyntaxNode::has_visit<T, void(const PropertySpecSyntax&)>::value ? v.visit(*(const PropertySpecSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicalRightShiftAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WildcardPortList: SyntaxNode::has_visit<T, void(const WildcardPortListSyntax&)>::value ? v.visit(*(const WildcardPortListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PortDeclaration: SyntaxNode::has_visit<T, void(const PortDeclarationSyntax&)>::value ? v.visit(*(const PortDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RepeatedEventControl: SyntaxNode::has_visit<T, void(const RepeatedEventControlSyntax&)>::value ? v.visit(*(const RepeatedEventControlSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::InterfaceDeclaration: SyntaxNode::has_visit<T, void(const ModuleDeclarationSyntax&)>::value ? v.visit(*(const ModuleDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::VariableDimension: SyntaxNode::has_visit<T, void(const VariableDimensionSyntax&)>::value ? v.visit(*(const VariableDimensionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CellDefineDirective: SyntaxNode::has_visit<T, void(const SimpleDirectiveSyntax&)>::value ? v.visit(*(const SimpleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IffClause: SyntaxNode::has_visit<T, void(const IffClauseSyntax&)>::value ? v.visit(*(const IffClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BitSelect: SyntaxNode::has_visit<T, void(const BitSelectSyntax&)>::value ? v.visit(*(const BitSelectSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExtendsClause: SyntaxNode::has_visit<T, void(const ExtendsClauseSyntax&)>::value ? v.visit(*(const ExtendsClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImmediateAssertionMember: SyntaxNode::has_visit<T, void(const ImmediateAssertionMemberSyntax&)>::value ? v.visit(*(const ImmediateAssertionMemberSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IntegerLiteralExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MultipleConcatenationExpression: SyntaxNode::has_visit<T, void(const MultipleConcatenationExpressionSyntax&)>::value ? v.visit(*(const MultipleConcatenationExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArrayXorMethod: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ByteType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnionType: SyntaxNode::has_visit<T, void(const StructUnionTypeSyntax&)>::value ? v.visit(*(const StructUnionTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PrimaryBlockEventExpression: SyntaxNode::has_visit<T, void(const PrimaryBlockEventExpressionSyntax&)>::value ? v.visit(*(const PrimaryBlockEventExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConcatenationExpression: SyntaxNode::has_visit<T, void(const ConcatenationExpressionSyntax&)>::value ? v.visit(*(const ConcatenationExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AnsiPortList: SyntaxNode::has_visit<T, void(const AnsiPortListSyntax&)>::value ? v.visit(*(const AnsiPortListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EmptyStatement: SyntaxNode::has_visit<T, void(const EmptyStatementSyntax&)>::value ? v.visit(*(const EmptyStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RegType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::VariableDeclarator: SyntaxNode::has_visit<T, void(const VariableDeclaratorSyntax&)>::value ? v.visit(*(const VariableDeclaratorSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NewClassExpression: SyntaxNode::has_visit<T, void(const NewClassExpressionSyntax&)>::value ? v.visit(*(const NewClassExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArithmeticLeftShiftAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImmediateAssumeStatement: SyntaxNode::has_visit<T, void(const ImmediateAssertionStatementSyntax&)>::value ? v.visit(*(const ImmediateAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BitType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ForeachLoopStatement: SyntaxNode::has_visit<T, void(const ForeachLoopStatementSyntax&)>::value ? v.visit(*(const ForeachLoopStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::InsideExpression: SyntaxNode::has_visit<T, void(const InsideExpressionSyntax&)>::value ? v.visit(*(const InsideExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SubtractExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IntersectSequenceExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ProceduralReleaseStatement: SyntaxNode::has_visit<T, void(const ProceduralDeassignStatementSyntax&)>::value ? v.visit(*(const ProceduralDeassignStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BeginKeywordsDirective: SyntaxNode::has_visit<T, void(const BeginKeywordsDirectiveSyntax&)>::value ? v.visit(*(const BeginKeywordsDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicalOrExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NonOverlappedImplicationPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::VirtualInterfaceType: SyntaxNode::has_visit<T, void(const VirtualInterfaceTypeSyntax&)>::value ? v.visit(*(const VirtualInterfaceTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ShortIntType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SuperHandle: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicalEquivalenceExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SimpleRangeSelect: SyntaxNode::has_visit<T, void(const RangeSelectSyntax&)>::value ? v.visit(*(const RangeSelectSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IdentifierName: SyntaxNode::has_visit<T, void(const IdentifierNameSyntax&)>::value ? v.visit(*(const IdentifierNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ParameterDeclaration: SyntaxNode::has_visit<T, void(const ParameterDeclarationSyntax&)>::value ? v.visit(*(const ParameterDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LoopStatement: SyntaxNode::has_visit<T, void(const LoopStatementSyntax&)>::value ? v.visit(*(const LoopStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ModportDeclaration: SyntaxNode::has_visit<T, void(const ModportDeclarationSyntax&)>::value ? v.visit(*(const ModportDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IncludeDirective: SyntaxNode::has_visit<T, void(const IncludeDirectiveSyntax&)>::value ? v.visit(*(const IncludeDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ClassPropertyDeclaration: SyntaxNode::has_visit<T, void(const ClassPropertyDeclarationSyntax&)>::value ? v.visit(*(const ClassPropertyDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::JumpStatement: SyntaxNode::has_visit<T, void(const JumpStatementSyntax&)>::value ? v.visit(*(const JumpStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ModExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DefineDirective: SyntaxNode::has_visit<T, void(const DefineDirectiveSyntax&)>::value ? v.visit(*(const DefineDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RealTimeType: SyntaxNode::has_visit<T, void(const KeywordTypeSyntax&)>::value ? v.visit(*(const KeywordTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ProgramHeader: SyntaxNode::has_visit<T, void(const ModuleHeaderSyntax&)>::value ? v.visit(*(const ModuleHeaderSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TypedefInterfaceClassDeclaration: SyntaxNode::has_visit<T, void(const TypedefInterfaceClassDeclarationSyntax&)>::value ? v.visit(*(const TypedefInterfaceClassDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UndefDirective: SyntaxNode::has_visit<T, void(const UndefDirectiveSyntax&)>::value ? v.visit(*(const UndefDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RejectOnPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DoWhileStatement: SyntaxNode::has_visit<T, void(const DoWhileStatementSyntax&)>::value ? v.visit(*(const DoWhileStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EmptyQueueExpression: SyntaxNode::has_visit<T, void(const EmptyQueueExpressionSyntax&)>::value ? v.visit(*(const EmptyQueueExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SubtractAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IfGenerate: SyntaxNode::has_visit<T, void(const IfGenerateSyntax&)>::value ? v.visit(*(const IfGenerateSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StructType: SyntaxNode::has_visit<T, void(const StructUnionTypeSyntax&)>::value ? v.visit(*(const StructUnionTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnbasedUnsizedLiteralExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArrayUniqueMethod: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NamedStructurePatternMember: SyntaxNode::has_visit<T, void(const NamedStructurePatternMemberSyntax&)>::value ? v.visit(*(const NamedStructurePatternMemberSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WaitStatement: SyntaxNode::has_visit<T, void(const WaitStatementSyntax&)>::value ? v.visit(*(const WaitStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::FunctionDeclaration: SyntaxNode::has_visit<T, void(const FunctionDeclarationSyntax&)>::value ? v.visit(*(const FunctionDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicalShiftLeftExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ClassDeclaration: SyntaxNode::has_visit<T, void(const ClassDeclarationSyntax&)>::value ? v.visit(*(const ClassDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NamedPortConnection: SyntaxNode::has_visit<T, void(const NamedPortConnectionSyntax&)>::value ? v.visit(*(const NamedPortConnectionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::HierarchicalInstance: SyntaxNode::has_visit<T, void(const HierarchicalInstanceSyntax&)>::value ? v.visit(*(const HierarchicalInstanceSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ForeverStatement: SyntaxNode::has_visit<T, void(const ForeverStatementSyntax&)>::value ? v.visit(*(const ForeverStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WildcardPattern: SyntaxNode::has_visit<T, void(const WildcardPatternSyntax&)>::value ? v.visit(*(const WildcardPatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArithmeticRightShiftAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WildcardInequalityExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::InitialBlock: SyntaxNode::has_visit<T, void(const ProceduralBlockSyntax&)>::value ? v.visit(*(const ProceduralBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SyncAcceptOnPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ThisHandle: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ModuleDeclaration: SyntaxNode::has_visit<T, void(const ModuleDeclarationSyntax&)>::value ? v.visit(*(const ModuleDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ElementSelectExpression: SyntaxNode::has_visit<T, void(const ElementSelectExpressionSyntax&)>::value ? v.visit(*(const ElementSelectExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PostdecrementExpression: SyntaxNode::has_visit<T, void(const PostfixUnaryExpressionSyntax&)>::value ? v.visit(*(const PostfixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnarySequenceDelayExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConditionalStatement: SyntaxNode::has_visit<T, void(const ConditionalStatementSyntax&)>::value ? v.visit(*(const ConditionalStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConstraintDeclaration: SyntaxNode::has_visit<T, void(const ConstraintDeclarationSyntax&)>::value ? v.visit(*(const ConstraintDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WildcardDimensionSpecifier: SyntaxNode::has_visit<T, void(const WildcardDimensionSpecifierSyntax&)>::value ? v.visit(*(const WildcardDimensionSpecifierSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImplementsClause: SyntaxNode::has_visit<T, void(const ImplementsClauseSyntax&)>::value ? v.visit(*(const ImplementsClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LetPortList: SyntaxNode::has_visit<T, void(const LetPortListSyntax&)>::value ? v.visit(*(const LetPortListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DotMemberClause: SyntaxNode::has_visit<T, void(const DotMemberClauseSyntax&)>::value ? v.visit(*(const DotMemberClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ChargeStrength: SyntaxNode::has_visit<T, void(const ChargeStrengthSyntax&)>::value ? v.visit(*(const ChargeStrengthSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AddExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NoUnconnectedDriveDirective: SyntaxNode::has_visit<T, void(const SimpleDirectiveSyntax&)>::value ? v.visit(*(const SimpleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ElseDirective: SyntaxNode::has_visit<T, void(const UnconditionalBranchDirectiveSyntax&)>::value ? v.visit(*(const UnconditionalBranchDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicalImplicationExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LessThanEqualExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DefaultCoverageBinInitializer: SyntaxNode::has_visit<T, void(const DefaultCoverageBinInitializerSyntax&)>::value ? v.visit(*(const DefaultCoverageBinInitializerSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TimingControlStatement: SyntaxNode::has_visit<T, void(const TimingControlStatementSyntax&)>::value ? v.visit(*(const TimingControlStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ForLoopStatement: SyntaxNode::has_visit<T, void(const ForLoopStatementSyntax&)>::value ? v.visit(*(const ForLoopStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StructurePattern: SyntaxNode::has_visit<T, void(const StructurePatternSyntax&)>::value ? v.visit(*(const StructurePatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AscendingRangeSelect: SyntaxNode::has_visit<T, void(const RangeSelectSyntax&)>::value ? v.visit(*(const RangeSelectSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EventuallyPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RangeCoverageBinInitializer: SyntaxNode::has_visit<T, void(const RangeCoverageBinInitializerSyntax&)>::value ? v.visit(*(const RangeCoverageBinInitializerSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SEventuallyPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConstructorName: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MacroFormalArgument: SyntaxNode::has_visit<T, void(const MacroFormalArgumentSyntax&)>::value ? v.visit(*(const MacroFormalArgumentSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PowerExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AssumePropertyStatement: SyntaxNode::has_visit<T, void(const ConcurrentAssertionStatementSyntax&)>::value ? v.visit(*(const ConcurrentAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::VariablePortHeader: SyntaxNode::has_visit<T, void(const VariablePortHeaderSyntax&)>::value ? v.visit(*(const VariablePortHeaderSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicalAndExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CaseGenerate: SyntaxNode::has_visit<T, void(const CaseGenerateSyntax&)>::value ? v.visit(*(const CaseGenerateSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LetDeclaration: SyntaxNode::has_visit<T, void(const LetDeclarationSyntax&)>::value ? v.visit(*(const LetDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::InterconnectPortHeader: SyntaxNode::has_visit<T, void(const InterconnectPortHeaderSyntax&)>::value ? v.visit(*(const InterconnectPortHeaderSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MultiplyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnconnectedDriveDirective: SyntaxNode::has_visit<T, void(const SimpleDirectiveSyntax&)>::value ? v.visit(*(const SimpleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BinaryXorExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DescendingRangeSelect: SyntaxNode::has_visit<T, void(const RangeSelectSyntax&)>::value ? v.visit(*(const RangeSelectSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PackageImportItem: SyntaxNode::has_visit<T, void(const PackageImportItemSyntax&)>::value ? v.visit(*(const PackageImportItemSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExpressionCoverageBinInitializer: SyntaxNode::has_visit<T, void(const ExpressionCoverageBinInitializerSyntax&)>::value ? v.visit(*(const ExpressionCoverageBinInitializerSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ClassName: SyntaxNode::has_visit<T, void(const ClassNameSyntax&)>::value ? v.visit(*(const ClassNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NonAnsiPortList: SyntaxNode::has_visit<T, void(const NonAnsiPortListSyntax&)>::value ? v.visit(*(const NonAnsiPortListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryBitwiseOrExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SimpleAssignmentPattern: SyntaxNode::has_visit<T, void(const SimpleAssignmentPatternSyntax&)>::value ? v.visit(*(const SimpleAssignmentPatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EqualityExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StringType: SyntaxNode::has_visit<T, void(const KeywordTypeSyntax&)>::value ? v.visit(*(const KeywordTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CovergroupDeclaration: SyntaxNode::has_visit<T, void(const CovergroupDeclarationSyntax&)>::value ? v.visit(*(const CovergroupDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImplicationConstraint: SyntaxNode::has_visit<T, void(const ImplicationConstraintSyntax&)>::value ? v.visit(*(const ImplicationConstraintSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ParameterValueAssignment: SyntaxNode::has_visit<T, void(const ParameterValueAssignmentSyntax&)>::value ? v.visit(*(const ParameterValueAssignmentSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SignedCastExpression: SyntaxNode::has_visit<T, void(const SignedCastExpressionSyntax&)>::value ? v.visit(*(const SignedCastExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ForeachLoopList: SyntaxNode::has_visit<T, void(const ForeachLoopListSyntax&)>::value ? v.visit(*(const ForeachLoopListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EmptyIdentifierName: SyntaxNode::has_visit<T, void(const EmptyIdentifierNameSyntax&)>::value ? v.visit(*(const EmptyIdentifierNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::GenvarDeclaration: SyntaxNode::has_visit<T, void(const GenvarDeclarationSyntax&)>::value ? v.visit(*(const GenvarDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::Coverpoint: SyntaxNode::has_visit<T, void(const CoverpointSyntax&)>::value ? v.visit(*(const CoverpointSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NetDeclaration: SyntaxNode::has_visit<T, void(const NetDeclarationSyntax&)>::value ? v.visit(*(const NetDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TimeLiteralExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AlwaysBlock: SyntaxNode::has_visit<T, void(const ProceduralBlockSyntax&)>::value ? v.visit(*(const ProceduralBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LessThanExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SUntilPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::FinalBlock: SyntaxNode::has_visit<T, void(const ProceduralBlockSyntax&)>::value ? v.visit(*(const ProceduralBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RestrictPropertyStatement: SyntaxNode::has_visit<T, void(const ConcurrentAssertionStatementSyntax&)>::value ? v.visit(*(const ConcurrentAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ParenthesizedExpression: SyntaxNode::has_visit<T, void(const ParenthesizedExpressionSyntax&)>::value ? v.visit(*(const ParenthesizedExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ModAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WaitOrderStatement: SyntaxNode::has_visit<T, void(const WaitOrderStatementSyntax&)>::value ? v.visit(*(const WaitOrderStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SignalEventExpression: SyntaxNode::has_visit<T, void(const SignalEventExpressionSyntax&)>::value ? v.visit(*(const SignalEventExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EndKeywordsDirective: SyntaxNode::has_visit<T, void(const SimpleDirectiveSyntax&)>::value ? v.visit(*(const SimpleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OpenRangeList: SyntaxNode::has_visit<T, void(const OpenRangeListSyntax&)>::value ? v.visit(*(const OpenRangeListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ParameterDeclarationStatement: SyntaxNode::has_visit<T, void(const ParameterDeclarationStatementSyntax&)>::value ? v.visit(*(const ParameterDeclarationStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArithmeticShiftRightExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DisableIff: SyntaxNode::has_visit<T, void(const DisableIffSyntax&)>::value ? v.visit(*(const DisableIffSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OneStepLiteralExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::InequalityExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImplicitNonAnsiPort: SyntaxNode::has_visit<T, void(const ImplicitNonAnsiPortSyntax&)>::value ? v.visit(*(const ImplicitNonAnsiPortSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ClassMethodDeclaration: SyntaxNode::has_visit<T, void(const ClassMethodDeclarationSyntax&)>::value ? v.visit(*(const ClassMethodDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ActionBlock: SyntaxNode::has_visit<T, void(const ActionBlockSyntax&)>::value ? v.visit(*(const ActionBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PackageHeader: SyntaxNode::has_visit<T, void(const ModuleHeaderSyntax&)>::value ? v.visit(*(const ModuleHeaderSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StandardCaseItem: SyntaxNode::has_visit<T, void(const StandardCaseItemSyntax&)>::value ? v.visit(*(const StandardCaseItemSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LocalScope: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OverlappedFollowedByPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StreamExpressionWithRange: SyntaxNode::has_visit<T, void(const StreamExpressionWithRange&)>::value ? v.visit(*(const StreamExpressionWithRange*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IntegerType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConditionalPredicate: SyntaxNode::has_visit<T, void(const ConditionalPredicateSyntax&)>::value ? v.visit(*(const ConditionalPredicateSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConditionalExpression: SyntaxNode::has_visit<T, void(const ConditionalExpressionSyntax&)>::value ? v.visit(*(const ConditionalExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::VoidType: SyntaxNode::has_visit<T, void(const KeywordTypeSyntax&)>::value ? v.visit(*(const KeywordTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ScopedName: SyntaxNode::has_visit<T, void(const ScopedNameSyntax&)>::value ? v.visit(*(const ScopedNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ProceduralDeassignStatement: SyntaxNode::has_visit<T, void(const ProceduralDeassignStatementSyntax&)>::value ? v.visit(*(const ProceduralDeassignStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryBitwiseNandExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IntType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CastExpression: SyntaxNode::has_visit<T, void(const CastExpressionSyntax&)>::value ? v.visit(*(const CastExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicalLeftShiftAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SystemName: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NetPortHeader: SyntaxNode::has_visit<T, void(const NetPortHeaderSyntax&)>::value ? v.visit(*(const NetPortHeaderSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ProceduralAssignStatement: SyntaxNode::has_visit<T, void(const ProceduralAssignStatementSyntax&)>::value ? v.visit(*(const ProceduralAssignStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EnumType: SyntaxNode::has_visit<T, void(const EnumTypeSyntax&)>::value ? v.visit(*(const EnumTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CaseEqualityExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SequentialBlockStatement: SyntaxNode::has_visit<T, void(const BlockStatementSyntax&)>::value ? v.visit(*(const BlockStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DefParam: SyntaxNode::has_visit<T, void(const DefParamSyntax&)>::value ? v.visit(*(const DefParamSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LongIntType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IfDefDirective: SyntaxNode::has_visit<T, void(const ConditionalBranchDirectiveSyntax&)>::value ? v.visit(*(const ConditionalBranchDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OrAssignmentExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CoverSequenceStatement: SyntaxNode::has_visit<T, void(const ConcurrentAssertionStatementSyntax&)>::value ? v.visit(*(const ConcurrentAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CoverageBins: SyntaxNode::has_visit<T, void(const CoverageBinsSyntax&)>::value ? v.visit(*(const CoverageBinsSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BinaryXnorExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TimeUnitsDeclaration: SyntaxNode::has_visit<T, void(const TimeUnitsDeclarationSyntax&)>::value ? v.visit(*(const TimeUnitsDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NonOverlappedFollowedByPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NamedArgument: SyntaxNode::has_visit<T, void(const NamedArgumentSyntax&)>::value ? v.visit(*(const NamedArgumentSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DisableStatement: SyntaxNode::has_visit<T, void(const DisableStatementSyntax&)>::value ? v.visit(*(const DisableStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CoverageOption: SyntaxNode::has_visit<T, void(const CoverageOptionSyntax&)>::value ? v.visit(*(const CoverageOptionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CompilationUnit: SyntaxNode::has_visit<T, void(const CompilationUnitSyntax&)>::value ? v.visit(*(const CompilationUnitSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CoverPropertyStatement: SyntaxNode::has_visit<T, void(const ConcurrentAssertionStatementSyntax&)>::value ? v.visit(*(const ConcurrentAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StreamExpression: SyntaxNode::has_visit<T, void(const StreamExpressionSyntax&)>::value ? v.visit(*(const StreamExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DistConstraintList: SyntaxNode::has_visit<T, void(const DistConstraintListSyntax&)>::value ? v.visit(*(const DistConstraintListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UniquenessConstraint: SyntaxNode::has_visit<T, void(const UniquenessConstraintSyntax&)>::value ? v.visit(*(const UniquenessConstraintSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WildcardPortConnection: SyntaxNode::has_visit<T, void(const WildcardPortConnectionSyntax&)>::value ? v.visit(*(const WildcardPortConnectionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MacroFormalArgumentList: SyntaxNode::has_visit<T, void(const MacroFormalArgumentListSyntax&)>::value ? v.visit(*(const MacroFormalArgumentListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SyncRejectOnPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::FunctionPrototype: SyntaxNode::has_visit<T, void(const FunctionPrototypeSyntax&)>::value ? v.visit(*(const FunctionPrototypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExpressionStatement: SyntaxNode::has_visit<T, void(const ExpressionStatementSyntax&)>::value ? v.visit(*(const ExpressionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UntilWithPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DataDeclaration: SyntaxNode::has_visit<T, void(const DataDeclarationSyntax&)>::value ? v.visit(*(const DataDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BinaryBlockEventExpression: SyntaxNode::has_visit<T, void(const BinaryBlockEventExpressionSyntax&)>::value ? v.visit(*(const BinaryBlockEventExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConstraintBlock: SyntaxNode::has_visit<T, void(const ConstraintBlockSyntax&)>::value ? v.visit(*(const ConstraintBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::InterfacePortHeader: SyntaxNode::has_visit<T, void(const InterfacePortHeaderSyntax&)>::value ? v.visit(*(const InterfacePortHeaderSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArgumentList: SyntaxNode::has_visit<T, void(const ArgumentListSyntax&)>::value ? v.visit(*(const ArgumentListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::GreaterThanExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImpliesPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryPredecrementExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryBitwiseAndExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PackageImportDeclaration: SyntaxNode::has_visit<T, void(const PackageImportDeclarationSyntax&)>::value ? v.visit(*(const PackageImportDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::Untyped: SyntaxNode::has_visit<T, void(const UntypedSyntax&)>::value ? v.visit(*(const UntypedSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IntegerVectorExpression: SyntaxNode::has_visit<T, void(const IntegerVectorExpressionSyntax&)>::value ? v.visit(*(const IntegerVectorExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AssignmentPatternItem: SyntaxNode::has_visit<T, void(const AssignmentPatternItemSyntax&)>::value ? v.visit(*(const AssignmentPatternItemSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WildcardLiteralExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IffPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DriveStrength: SyntaxNode::has_visit<T, void(const DriveStrengthSyntax&)>::value ? v.visit(*(const DriveStrengthSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StringLiteralExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TimeType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AlwaysFFBlock: SyntaxNode::has_visit<T, void(const ProceduralBlockSyntax&)>::value ? v.visit(*(const ProceduralBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UndefineAllDirective: SyntaxNode::has_visit<T, void(const SimpleDirectiveSyntax&)>::value ? v.visit(*(const SimpleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MacroUsage: SyntaxNode::has_visit<T, void(const MacroUsageSyntax&)>::value ? v.visit(*(const MacroUsageSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExplicitAnsiPort: SyntaxNode::has_visit<T, void(const ExplicitAnsiPortSyntax&)>::value ? v.visit(*(const ExplicitAnsiPortSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DeferredAssertion: SyntaxNode::has_visit<T, void(const DeferredAssertionSyntax&)>::value ? v.visit(*(const DeferredAssertionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::StructUnionMember: SyntaxNode::has_visit<T, void(const StructUnionMemberSyntax&)>::value ? v.visit(*(const StructUnionMemberSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::FunctionPortList: SyntaxNode::has_visit<T, void(const FunctionPortListSyntax&)>::value ? v.visit(*(const FunctionPortListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ColonExpressionClause: SyntaxNode::has_visit<T, void(const ColonExpressionClauseSyntax&)>::value ? v.visit(*(const ColonExpressionClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ElseClause: SyntaxNode::has_visit<T, void(const ElseClauseSyntax&)>::value ? v.visit(*(const ElseClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TypedefDeclaration: SyntaxNode::has_visit<T, void(const TypedefDeclarationSyntax&)>::value ? v.visit(*(const TypedefDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ThroughoutSequenceExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OrderedPortConnection: SyntaxNode::has_visit<T, void(const OrderedPortConnectionSyntax&)>::value ? v.visit(*(const OrderedPortConnectionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ConcurrentAssertionMember: SyntaxNode::has_visit<T, void(const ConcurrentAssertionMemberSyntax&)>::value ? v.visit(*(const ConcurrentAssertionMemberSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AssertPropertyStatement: SyntaxNode::has_visit<T, void(const ConcurrentAssertionStatementSyntax&)>::value ? v.visit(*(const ConcurrentAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OverlappedImplicationPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryPlusExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AlwaysCombBlock: SyntaxNode::has_visit<T, void(const ProceduralBlockSyntax&)>::value ? v.visit(*(const ProceduralBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ProceduralForceStatement: SyntaxNode::has_visit<T, void(const ProceduralAssignStatementSyntax&)>::value ? v.visit(*(const ProceduralAssignStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExpectPropertyStatement: SyntaxNode::has_visit<T, void(const ConcurrentAssertionStatementSyntax&)>::value ? v.visit(*(const ConcurrentAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BinaryEventExpression: SyntaxNode::has_visit<T, void(const BinaryEventExpressionSyntax&)>::value ? v.visit(*(const BinaryEventExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PackageDeclaration: SyntaxNode::has_visit<T, void(const ModuleDeclarationSyntax&)>::value ? v.visit(*(const ModuleDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::OrderedArgument: SyntaxNode::has_visit<T, void(const OrderedArgumentSyntax&)>::value ? v.visit(*(const OrderedArgumentSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::GreaterThanEqualExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RandCaseStatement: SyntaxNode::has_visit<T, void(const RandCaseStatementSyntax&)>::value ? v.visit(*(const RandCaseStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ProgramDeclaration: SyntaxNode::has_visit<T, void(const ModuleDeclarationSyntax&)>::value ? v.visit(*(const ModuleDeclarationSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MacroActualArgument: SyntaxNode::has_visit<T, void(const MacroActualArgumentSyntax&)>::value ? v.visit(*(const MacroActualArgumentSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RealLiteralExpression: SyntaxNode::has_visit<T, void(const LiteralExpressionSyntax&)>::value ? v.visit(*(const LiteralExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ReplicatedAssignmentPattern: SyntaxNode::has_visit<T, void(const ReplicatedAssignmentPatternSyntax&)>::value ? v.visit(*(const ReplicatedAssignmentPatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WithFunctionSample: SyntaxNode::has_visit<T, void(const WithFunctionSampleSyntax&)>::value ? v.visit(*(const WithFunctionSampleSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NamedLabel: SyntaxNode::has_visit<T, void(const NamedLabelSyntax&)>::value ? v.visit(*(const NamedLabelSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AlwaysLatchBlock: SyntaxNode::has_visit<T, void(const ProceduralBlockSyntax&)>::value ? v.visit(*(const ProceduralBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PatternCaseItem: SyntaxNode::has_visit<T, void(const PatternCaseItemSyntax&)>::value ? v.visit(*(const PatternCaseItemSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BadExpression: SyntaxNode::has_visit<T, void(const BadExpressionSyntax&)>::value ? v.visit(*(const BadExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExpressionConstraint: SyntaxNode::has_visit<T, void(const ExpressionConstraintSyntax&)>::value ? v.visit(*(const ExpressionConstraintSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryBitwiseXnorExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RootScope: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RandCaseItem: SyntaxNode::has_visit<T, void(const RandCaseItemSyntax&)>::value ? v.visit(*(const RandCaseItemSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MacroActualArgumentList: SyntaxNode::has_visit<T, void(const MacroActualArgumentListSyntax&)>::value ? v.visit(*(const MacroActualArgumentListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::DefParamAssignment: SyntaxNode::has_visit<T, void(const DefParamAssignmentSyntax&)>::value ? v.visit(*(const DefParamAssignmentSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BlockCoverageEvent: SyntaxNode::has_visit<T, void(const BlockCoverageEventSyntax&)>::value ? v.visit(*(const BlockCoverageEventSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryPreincrementExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LoopGenerate: SyntaxNode::has_visit<T, void(const LoopGenerateSyntax&)>::value ? v.visit(*(const LoopGenerateSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WithClause: SyntaxNode::has_visit<T, void(const WithClauseSyntax&)>::value ? v.visit(*(const WithClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::GenerateRegion: SyntaxNode::has_visit<T, void(const GenerateRegionSyntax&)>::value ? v.visit(*(const GenerateRegionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CaseStatement: SyntaxNode::has_visit<T, void(const CaseStatementSyntax&)>::value ? v.visit(*(const CaseStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UnaryBitwiseXorExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ShortRealType: SyntaxNode::has_visit<T, void(const KeywordTypeSyntax&)>::value ? v.visit(*(const KeywordTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ElsIfDirective: SyntaxNode::has_visit<T, void(const ConditionalBranchDirectiveSyntax&)>::value ? v.visit(*(const ConditionalBranchDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IdentifierList: SyntaxNode::has_visit<T, void(const IdentifierListSyntax&)>::value ? v.visit(*(const IdentifierListSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::NamedBlockClause: SyntaxNode::has_visit<T, void(const NamedBlockClauseSyntax&)>::value ? v.visit(*(const NamedBlockClauseSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EndCellDefineDirective: SyntaxNode::has_visit<T, void(const SimpleDirectiveSyntax&)>::value ? v.visit(*(const SimpleDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::RangeDimensionSpecifier: SyntaxNode::has_visit<T, void(const RangeDimensionSpecifierSyntax&)>::value ? v.visit(*(const RangeDimensionSpecifierSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SAlwaysPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EventType: SyntaxNode::has_visit<T, void(const KeywordTypeSyntax&)>::value ? v.visit(*(const KeywordTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArithmeticShiftLeftExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ElementSelect: SyntaxNode::has_visit<T, void(const ElementSelectSyntax&)>::value ? v.visit(*(const ElementSelectSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::EventControlWithExpression: SyntaxNode::has_visit<T, void(const EventControlWithExpressionSyntax&)>::value ? v.visit(*(const EventControlWithExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LoopConstraint: SyntaxNode::has_visit<T, void(const LoopConstraintSyntax&)>::value ? v.visit(*(const LoopConstraintSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::BinarySequenceDelayExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::GenerateBlock: SyntaxNode::has_visit<T, void(const GenerateBlockSyntax&)>::value ? v.visit(*(const GenerateBlockSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::AcceptOnPropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExpressionOrDist: SyntaxNode::has_visit<T, void(const ExpressionOrDistSyntax&)>::value ? v.visit(*(const ExpressionOrDistSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::TaggedPattern: SyntaxNode::has_visit<T, void(const TaggedPatternSyntax&)>::value ? v.visit(*(const TaggedPatternSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::IfNDefDirective: SyntaxNode::has_visit<T, void(const ConditionalBranchDirectiveSyntax&)>::value ? v.visit(*(const ConditionalBranchDirectiveSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::WaitForkStatement: SyntaxNode::has_visit<T, void(const WaitForkStatementSyntax&)>::value ? v.visit(*(const WaitForkStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::PostincrementExpression: SyntaxNode::has_visit<T, void(const PostfixUnaryExpressionSyntax&)>::value ? v.visit(*(const PostfixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::UntilPropertyExpression: SyntaxNode::has_visit<T, void(const BinaryExpressionSyntax&)>::value ? v.visit(*(const BinaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::LogicType: SyntaxNode::has_visit<T, void(const IntegerTypeSyntax&)>::value ? v.visit(*(const IntegerTypeSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ExplicitNonAnsiPort: SyntaxNode::has_visit<T, void(const ExplicitNonAnsiPortSyntax&)>::value ? v.visit(*(const ExplicitNonAnsiPortSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ArrayAndMethod: SyntaxNode::has_visit<T, void(const KeywordNameSyntax&)>::value ? v.visit(*(const KeywordNameSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::MemberAccessExpression: SyntaxNode::has_visit<T, void(const MemberAccessExpressionSyntax&)>::value ? v.visit(*(const MemberAccessExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::SNextTimePropertyExpression: SyntaxNode::has_visit<T, void(const PrefixUnaryExpressionSyntax&)>::value ? v.visit(*(const PrefixUnaryExpressionSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::ImmediateCoverStatement: SyntaxNode::has_visit<T, void(const ImmediateAssertionStatementSyntax&)>::value ? v.visit(*(const ImmediateAssertionStatementSyntax*)node) : v.defaultVisit(*node); break;
        case SyntaxKind::CHandleType: SyntaxNode::has_visit<T, void(const KeywordTypeSyntax&)>::value ? v.visit(*(const KeywordTypeSyntax*)node) : v.defaultVisit(*node); break;
    }
}
