...
//! @brief Data flow analysis pass interface
//
...
/// The base interface for performing data flow analysis on procedures.
///
...
class SLANG_EXPORT DataFlowAnalysis {
public:
...
protected:
    DataFlowAnalysis(AnalysisContext& context, const SmallVectorBase<SymbolBitMap>& stateRef);
