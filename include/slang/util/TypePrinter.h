...
// Courtesy of: https://stackoverflow.com/questions/81870/is-it-possible-to-print-a-variables-type-in-standard-c/64490578#64490578
...
#error "Unsupported compiler"
        ...
        constexpr std::size_t wrappedTypeNameSuffixLength() {
            return wrappedTypeName<type_name_prober>().length()
