...
public:
    ...
    inline bool isStruct() const { return kind == Kind::Struct; }
    inline bool isEnum() const { return kind == Kind::Enum; }
    inline bool isLocalParam() const { return kind == Kind::LocalParam; }
...
protected:
    ...
    static constexpr std::array<std::string_view, 97> cppReservedKeywords = {"alignas",
                                                                             "alignof",
                                                                             "and",
                                                                             "and_eq",
                                                                             "asm",
